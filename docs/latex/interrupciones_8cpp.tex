...
\begin{DoxyCompactList}\small\item\em ISR del temporizador de hardware. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Función de servicio de interrupción (ISR) para detener la rutina principal. Se ejecuta cuando se detecta el evento de detención en el pin de interrupción. Esta función probablemente establece {\ttfamily RUN = false;}. \end{DoxyCompactList}\item 
...
\Hypertarget{interrupciones_8cpp_ad381aa5df28fccb991bc49fcb5856b43}\index{interrupciones.cpp@{interrupciones.cpp}!handleStop@{handleStop}}
...
Función de servicio de interrupción (ISR) para detener la rutina principal. Se ejecuta cuando se detecta el evento de detención en el pin de interrupción. Esta función probablemente establece {\ttfamily RUN = false;}. 

\Hypertarget{interrupciones_8cpp_ac53dd4166bbabe4a14d5b971c70a1782}\index{interrupciones.cpp@{interrupciones.cpp}!setupInterrupciones@{setupInterrupciones}}
...
\Hypertarget{interrupciones_8cpp_acf66a057f87b336c4cf02522f7ceffe6}\index{interrupciones.cpp@{interrupciones.cpp}!timerInterrupcion@{timerInterrupcion}}
...
\Hypertarget{interrupciones_8cpp_a19e9ff7a81b67d662134bed2ba41a3b3}\index{interrupciones.cpp@{interrupciones.cpp}!has\_expired@{has\_expired}}
...
\Hypertarget{interrupciones_8cpp_a7f58a663d672fc7724b47068352249df}\index{interrupciones.cpp@{interrupciones.cpp}!SETPOINT@{SETPOINT}}
...
\Hypertarget{interrupciones_8cpp_a10d4f5ea5fffb797d3564654ccefedf8}\index{interrupciones.cpp@{interrupciones.cpp}!TIEMPO\_TIMER@{TIEMPO\_TIMER}}
